...
\textcolor{gray}{%
    Based on \mono[codebluebright]{py.path.local} from the \mono[codebluebright]{py} library (\mono[codebluebright]{pylib}) \\
    instead, since \mono[codebluebright]{pathlib} only exists since Python 3.4. Should not be used in new code.
}
