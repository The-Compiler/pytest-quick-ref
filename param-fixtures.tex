\section{Advanced fixture parametrization}
\linksubsection{fixt-parametrize}{Fixture Params}
...
\linksubsection{indirect}{Indirect Parametrization}
...
\begin{tikzpicture}[test/.append style={minimum width=4.5cm}]
    ...
    \node [test, below=4mm of testbase, minimum height=1cm, minimum width=5.5cm] (testprod) {\monot{test\_debug[\textcolor{pygnum}{prod.json}-\textcolor{pygnum}{False}]}};
