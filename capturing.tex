...
\begin{minted}[autogobble,escapeinside=||]{text}
    ...
    |\textcolor{termred}{ls: cannot access \PYGZsq{}doesnotexist\PYGZsq{}: \codeskip}|
...
\linksubsection{logging}{Capturing Logs}
...
\vfill
\includegraphics[width=\linewidth]{img/illustrations/assert-introspection.png}
\vfill
