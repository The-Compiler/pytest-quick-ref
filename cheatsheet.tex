...
\begin{center}
    ...
    \begin{minipage}{.75\linewidth}
        ...
        \large
        Python / \bold{pytest trainings}, \\ consulting and development by one of \bold{pytest's core maintainers}. \\
    \end{minipage}
    ...
    \vfill
    {\small \faCreativeCommons{} \faCreativeCommonsBy{} \faCreativeCommonsNd{} \, CC BY-ND 4.0 \hfill \faCopyright[regular]{} \, 2026 Freya Bruhin}
\end{center}
\end{document}
