...
\begin{center}
\includegraphics[width=.8\linewidth]{img/illustrations/mocking.png}
\end{center}
...
\begin{minipage}{.57\linewidth}
    \begin{tikzpicture}[
            mock/.style={
                    bluenodebright,
                    align=left,
                    label={[xshift=-4.5em]above:\mono{Mock}},
                    text width=4.25cm,
                },
        ]
        \node [mock] (dev) {
...
\begin{description}[labelwidth=9em, leftmargin=!, itemsep=0pt]
    \item[requests] \textbf{responses}, betamax
    \item[aiohttp] aioresponses
    \item[HTTP in general] \textbf{VCR.py}, pook
