%\section{Debugging failing tests}  % FIXME

\linksection{output}{Args to control output}
\begin{tabular}{rrl}
...
\linksection{mathspp-select}{Args to select tests}
\newcommand*{\drawex}[1]{%
    \begin{tikzpicture}[
...
\section{Tracing fixture execution}
\begin{description}
...
\section{Adding information to an assert}
...
\linksection{pdb}{The pdb debugger}
...
\section{Showing slow test durations}
...
\linksection{faulthandler}{Hanging tests}
