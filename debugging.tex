...
% \linksubsection{output}{Arguments to Control Output}
\subsection[Arguments to Control Output]{\makebox[\linewidth][s]{Args to Control Output\sectionlink{output}}}
...
\raisebox{.7ex}{pass:} \hspace{.15em} \drawex{\phantom{1}/good} \hspace{1em} \raisebox{.7ex}{fail:} \drawex{\phantom{1}/bad} \hspace{1em} \raisebox{.7ex}{new:} \drawex{\phantom{1}/new} \\[.5em]
\vspace{-1em}
...
Codecov Test Analytics, cloudreport.dev (has a local mode), flakytest.dev or BuildPulse.
