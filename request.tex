...
Fixture functions can receive a \mono{request} object with \\
attributes:

\begin{minted}[highlightlines=8-9,autogobble,escapeinside=||]{python}
    @pytest.fixture
...
\begin{itemize}
    \item[] \hspace{-1.25em}\qrcode[height=2em]{https://github.com/pytest-dev/pytest/issues/349}\hspace{1em}\begin{minipage}{.9\linewidth}pytest issue 349: \\ Using fixtures in \mono{pytest.mark.parametrize}\end{minipage} \\[.25em]
    \item[] \hspace{-1.25em}\qrcode[height=2em]{https://smarie.github.io/python-pytest-cases/}\hspace{1em}\begin{minipage}{.9\linewidth}The \mono{pytest-cases} plugin for more sophisticated parametrization\end{minipage}
\end{itemize}
...
\linksubsection{fixt-markers}{Accessing Markers}
...
\linksubsection{fixt-addoption}{Custom CLI Flags}
Using a plugin hook, you can also customize fixture \\
behavior based on custom CLI flags:
